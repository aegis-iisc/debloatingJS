...
*/
    ...
    it('check-loaded-json', function () {
        var verified = commons.compareLoadedWithExpected(testName, false);
        assert(verified);
    });

    it('check-invoked-json', function () {
        var verified = commons.compareExecutedWithExpected(testName, false);
        assert(verified);
    });
...
describe('unit-tests', function () {
    ...
    describe('two-funtions-one-executed', function () {
        runTests('test4');
    });
