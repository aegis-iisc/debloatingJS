...
describe('unit-tests', function () {
    ...
    describe('single-function-not-executed', function () {runTests('test1');});
    describe('single-function-executed', function () { runTests('test3'); });
    describe('two-functions-one-executed', function () {runTests('test4');  });
    ...
    describe('function-call-2', function () { runTests('function-call-2'); }); // TODO :: The test failed as the dynamically loaded function does not return the result value while the original function returns it.
    describe('function-apply', function () { runTests('function-apply'); });
    describe('function-apply', function () { runTests('function-apply-unexercised'); });
    ...
    describe('callback-unexecuted', function () { runTests('callback-unexecuted'); }); //=> Dynamic analysis cannot capture unexecuted callback function.
   ...
   describe('function-expression', function() {
    ...
    // TODO : How to handle such scenarios if src location generated by Jalangi has some error
    // TODO : Debug this Priority 1
