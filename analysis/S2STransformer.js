...
// not used
function splitStubFileAsync(){


    fs.readFile(stubbingFuncList, "utf8", function(err, data) {
        if (err) {
           console.log("The file " + stubbingFuncList.toString() + " cannot be read ");
        }else{
            var dataAsArray = data.toString().split("\n");
