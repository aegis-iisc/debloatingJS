    ...
    method("rejectedWith", function (errorLike, errMsgMatcher, message) {
        ...
        var derivedPromise = getBasePromise(this).then(function (value) {
            ...
            if (negate && everyArgIsDefined) {
                ...
                if (errMsgMatcher) {
                    _this3.assert(errMsgMatcherCompatible, "expected promise to be rejected with an error " + matcherRelation + " #{exp} but got " + "#{act}", "expected promise not to be rejected with an error " + matcherRelation + " #{exp}", errMsgMatcher, checkError.getMessage(reason));
                }
            }
