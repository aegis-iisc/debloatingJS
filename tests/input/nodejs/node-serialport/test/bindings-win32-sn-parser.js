...
var serialNumParser = require('../lib/bindings/win32-sn-parser');
...
describe('test97- serialNumParser', function () {
  Object.keys(devices).forEach(function (device) {
    it('parses pnp id for ' + device, function () {
      var pnpId = devices[device].pnpId;
      var serialNumber = devices[device].serialNumber;
