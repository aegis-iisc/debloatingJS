...
ruleTester.run('no-callback-literal', rule, {
  ...
  // random stuff
  'horse()', 'sort(null)', 'require("zyx")', 'require("zyx", data)',

  // callback()
  'callback()', 'callback(undefined)', 'callback(null)', 'callback(x)', 'callback(new Error("error"))', 'callback(friendly, data)', 'callback(null, data)', 'callback(x, data)', 'callback(new Error("error"), data)',

  // cb()
  'cb()', 'cb(undefined)', 'cb(null)', 'cb(null, "super")',
