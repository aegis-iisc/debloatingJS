...
ruleTester.run('array-bracket-even-spacing', rule, {
  ...
  // either
  { code: 'var x = [ a ]', options: ['either'] }, { code: 'var x = [a]', options: ['either'] }, { code: 'var x = [a,b,c]', options: ['either'] }, { code: 'var x = [ a,b,c ]', options: ['either'] }, { code: 'var x = [\na,b,c\n]', options: ['either'] }, { code: 'var x = [\n\ta,b,c\n]', options: ['either'] }, { code: 'var foo = [];', options: ['either'] }, { code: 'var [x] = y', options: ['either'], parserOptions: parserOptions }, { code: 'var [ x ] = y', options: ['either'], parserOptions: parserOptions }, { code: 'var [\nx\n] = y', options: ['either'], parserOptions: parserOptions }, { code: 'var [\n\tx\n] = y', options: ['either'], parserOptions: parserOptions }, { code: 'var foo = obj[ 1 ]', options: ['always'] }, { code: "var foo = obj[ 'foo' ];", options: ['always'] }, { code: 'var foo = obj[ [ 1, 1 ] ];', options: ['always'] },

  // always - singleValue
  { code: "var foo = ['foo']", options: ['always', { singleValue: false }] }, { code: 'var foo = [2]', options: ['always', { singleValue: false }] }, { code: 'var foo = [[ 1, 1 ]]', options: ['always', { singleValue: false }] }, { code: "var foo = [{ 'foo': 'bar' }]", options: ['always', { singleValue: false }] }, { code: 'var foo = [bar]', options: ['always', { singleValue: false }] },

  // always - objectsInArrays
  { code: "var foo = [{ 'bar': 'baz' }, 1,  5 ];", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [ 1, 5, { 'bar': 'baz' }];", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [{\n'bar': 'baz', \n'qux': [{ 'bar': 'baz' }], \n'quxx': 1 \n}]", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [{ 'bar': 'baz' }]", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [{ 'bar': 'baz' }, 1, { 'bar': 'baz' }];", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [ 1, { 'bar': 'baz' }, 5 ];", options: ['always', { objectsInArrays: false }] }, { code: "var foo = [ 1, { 'bar': 'baz' }, [{ 'bar': 'baz' }] ];", options: ['always', { objectsInArrays: false }] },

  // always - arraysInArrays
  { code: 'var arr = [[ 1, 2 ], 2, 3, 4 ];', options: ['always', { 'arraysInArrays': false }] }, { code: 'var arr = [[ 1, 2 ], [[[ 1 ]]], 3, 4 ];', options: ['always', { 'arraysInArrays': false }] },
  ...
  { code: 'var [ x, y ] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [ x,y ] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [ x, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx, y ] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx,,,\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [ ,x, ] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx, ...y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] }, { code: 'var [\nx, ...y ] = z', parserOptions: { ecmaVersion: 6 }, options: ['always'] },

  // never
  { code: 'obj[foo]', options: ['never'] }, { code: "obj['foo']", options: ['never'] }, { code: "obj['foo' + 'bar']", options: ['never'] }, { code: "obj['foo'+'bar']", options: ['never'] }, { code: 'obj[obj2[foo]]', options: ['never'] }, { code: 'obj.map(function(item) { return [\n1,\n2,\n3,\n4\n]; })', options: ['never'] }, { code: "obj['map'](function(item) { return [\n1,\n2,\n3,\n4\n]; })", options: ['never'] }, { code: "obj['for' + 'Each'](function(item) { return [\n1,\n2,\n3,\n4\n]; })", options: ['never'] }, { code: "obj['for' + 'Each'](function(item) { return [\n1,\n2,\n3,\n4\n]; })", options: ['never'] }, { code: 'var arr = [1, 2, 3, 4];', options: ['never'] }, { code: 'var arr = [[1, 2], 2, 3, 4];', options: ['never'] }, { code: 'var arr = [\n1, 2, 3, 4\n];', options: ['never'] }, { code: 'obj[\nfoo]', options: ['never'] }, { code: 'obj[foo\n]', options: ['never'] }, { code: 'var arr = [1,\n2,\n3,\n4\n];', options: ['never'] }, { code: 'var arr = [\n1,\n2,\n3,\n4];', options: ['never'] },

  // never - destructuring assignment
  { code: 'var [x, y] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [x,y] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [x, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx, y] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx, y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx,,,\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [,x,] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx, ...y\n] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] }, { code: 'var [\nx, ...y] = z', parserOptions: { ecmaVersion: 6 }, options: ['never'] },

  // never - singleValue
  { code: "var foo = [ 'foo' ]", options: ['never', { singleValue: true }] }, { code: 'var foo = [ 2 ]', options: ['never', { singleValue: true }] }, { code: 'var foo = [ [1, 1] ]', options: ['never', { singleValue: true }] }, { code: "var foo = [ {'foo': 'bar'} ]", options: ['never', { singleValue: true }] }, { code: 'var foo = [ bar ]', options: ['never', { singleValue: true }] },

  // never - objectsInArrays
  { code: "var foo = [ {'bar': 'baz'}, 1, 5];", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [1, 5, {'bar': 'baz'} ];", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [ {\n'bar': 'baz', \n'qux': [ {'bar': 'baz'} ], \n'quxx': 1 \n} ]", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [ {'bar': 'baz'} ]", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [ {'bar': 'baz'}, 1, {'bar': 'baz'} ];", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [1, {'bar': 'baz'} , 5];", options: ['never', { objectsInArrays: true }] }, { code: "var foo = [1, {'bar': 'baz'}, [ {'bar': 'baz'} ]];", options: ['never', { objectsInArrays: true }] },
  ...
  // should not warn
  { code: 'var foo = {};', options: ['never'] }, { code: 'var foo = [];', options: ['never'] }, { code: "var foo = [{'bar':'baz'}, 1, {'bar': 'baz'}];", options: ['never'] }, { code: "var foo = [{'bar': 'baz'}];", options: ['never'] }, { code: "var foo = [{\n'bar': 'baz', \n'qux': [{'bar': 'baz'}], \n'quxx': 1 \n}]", options: ['never'] }, { code: "var foo = [1, {'bar': 'baz'}, 5];", options: ['never'] }, { code: "var foo = [{'bar': 'baz'}, 1,  5];", options: ['never'] }, { code: "var foo = [1, 5, {'bar': 'baz'}];", options: ['never'] }, { code: "var obj = {'foo': [1, 2]}", options: ['never'] }],
