...
Prompt.prototype.run = function (answers) {
  ...
  return Promise.resolve(this.when(answers)).then(function (when) {
    if (when === false) {
      self.end(false);
    ...
    return new Promise(function (resolve) {
      self.ask(function (input) {
        Promise.resolve(self.transform(input)).then(function (answer) {
...
Prompt.prototype.dispatch = function (input, key) {
  ...
  return Promise.resolve(this.validate(input, key)).then(function (state) {
    self.state = state;
...
Prompt.ask = function (question, answers, ui) {
  ...
  var cb = args.pop();
  var prompt = new (Function.prototype.bind.apply(this, [null].concat(_toConsumableArray(args))))();
  prompt.ask(cb);
};
...
Prompt.run = function () {
  var prompt = new (Function.prototype.bind.apply(this, [null].concat(Array.prototype.slice.call(arguments))))();
  return prompt.run();
};
