...
(function () {
	(function (chaiSubset) {
		...
		function compare(expected, actual) {
			...
			if ((typeof actual === 'undefined' ? 'undefined' : _typeof(actual)) !== (typeof expected === 'undefined' ? 'undefined' : _typeof(expected))) {
				return false;
			}
			if ((typeof expected === 'undefined' ? 'undefined' : _typeof(expected)) !== 'object' || expected === null) {
			...
			return Object.keys(expected).every(function (key) {
				var eo = expected[key];
				var ao = actual[key];
				if ((typeof eo === 'undefined' ? 'undefined' : _typeof(eo)) === 'object' && eo !== null && ao !== null) {
