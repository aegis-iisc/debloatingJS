...
(function () {
  var n = this,
  ...
  };"undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = j), exports._ = j) : n._ = j, j.VERSION = "1.6.0";var A = j.each = j.forEach = function (n, t, e) {
    if (null == n) return n;if (s && n.forEach === s) n.forEach(t, e);else if (n.length === +n.length) {
  ...
  };var O = "Reduce of empty array with no initial value";j.reduce = j.foldl = j.inject = function (n, t, r, e) {
    ...
    var e;return k(n, function (n, u, i) {
    ...
    if (!t && j.isArray(n) && n[0] === +n[0] && n.length < 65535) return Math.max.apply(Math, n);var e = -1 / 0,
        u = -1 / 0;return A(n, function (n, i, a) {
      var o = t ? t.call(r, n, i, a) : n;o > u && (e = n, u = o);
    }), e;
  }, j.min = function (n, t, r) {
    if (!t && j.isArray(n) && n[0] === +n[0] && n.length < 65535) return Math.min.apply(Math, n);var e = 1 / 0,
        u = 1 / 0;return A(n, function (n, i, a) {
      var o = t ? t.call(r, n, i, a) : n;u > o && (e = n, u = o);
    }), e;
    ...
    return function (t, r, e) {
      var u = {};return r = E(r), A(t, function (i, a) {
        var o = r.call(e, i, a, t);n(u, o, i);
      }), u;
    };
    ...
    r = E(r);for (var u = r.call(e, t), i = 0, a = n.length; a > i;) {
    ...
    var e,
      ...
      var l = j.now();o || r.leading !== !1 || (o = l);var f = t - (l - o);return e = this, u = arguments, 0 >= f ? (clearTimeout(a), a = null, o = l, i = n.apply(e, u), e = u = null) : a || r.trailing === !1 || (a = setTimeout(c, f)), i;
    };
    ...
    var e,
        ...
        o,
        c = function c() {
      var l = j.now() - a;t > l ? e = setTimeout(c, t - l) : (e = null, r || (o = n.apply(i, u), i = u = null));
    };return function () {
      i = this, u = arguments, a = j.now();var l = r && !e;return e || (e = setTimeout(c, t)), l && (o = n.apply(i, u), i = u = null), o;
    };
  }, j.once = function (n) {
    var t,
        r = !1;return function () {
    ...
    if (!j.isObject(n)) return [];if (w) return w(n);var t = [];for (var r in n) {
      j.has(n, r) && t.push(r);
    }return t;
  }, j.values = function (n) {
    ...
    if (n === t) return 0 !== n || 1 / n == 1 / t;if (null == n || null == t) return n === t;n instanceof j && (n = n._wrapped), t instanceof j && (t = t._wrapped);var u = l.call(n);if (u != l.call(t)) return !1;switch (u) {case "[object String]":
      ...
      if (r[i] == n) return e[i] == t;
        ...
        o = t.constructor;if (a !== o && !(j.isFunction(a) && a instanceof a && j.isFunction(o) && o instanceof o) && "constructor" in n && "constructor" in t) return !1;r.push(n), e.push(t);var c = 0,
    ...
    return function (t) {
      if (t === n) return !0;for (var r in n) {
        if (n[r] !== t[r]) return !1;
      }return !0;
    };
  ...
  };var T = { escape: { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;" } };T.unescape = j.invert(T.escape);var I = { escape: new RegExp("[" + j.keys(T.escape).join("") + "]", "g"), unescape: new RegExp("(" + j.keys(T.unescape).join("|") + ")", "g") };j.each(["escape", "unescape"], function (n) {
    j[n] = function (t) {
