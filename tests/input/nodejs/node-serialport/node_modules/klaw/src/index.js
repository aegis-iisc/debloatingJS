...
function Walker(dir, options) {
  assert.strictEqual(typeof dir === 'undefined' ? 'undefined' : _typeof(dir), 'string', '`dir` parameter should be of type string. Got type: ' + (typeof dir === 'undefined' ? 'undefined' : _typeof(dir)));
