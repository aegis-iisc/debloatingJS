...
function list(auth, type, org, options, callback) {
  ...
  if (org == null) {
    ...
    if (type == 'org') urlbase += '/orgs/' + org + '/repos?';else urlbase += '/users/' + org + '/repos?';
  }
...
;['refs', 'tags', 'branches', 'commits'].forEach(function (type) {
  ...
  var lister = function lister(auth, org, repo, options, callback) {
  ...
  // no getTag API
  var getter = function getter(auth, org, repo, ref, options, callback) {
    if (typeof options == 'function') {
      callback = options;
      options = {};
    }
