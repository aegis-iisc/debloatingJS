...
if ((typeof module === "undefined" ? "undefined" : _typeof(module)) === "object" && typeof require === "function") {
...
(function () {
    ...
    tests("deepEqual", function (pass, fail) {
        ...
        fail("-0 to +0", -0, +0);
        fail("-0 to 0", -0, 0);
        fail("objects with different own properties", { id: 42 }, { id: 42, di: 24 });
        ...
        pass("arrays", [1, 2, "Hey there", func, { id: 42, prop: [2, 3] }], [1, 2, "Hey there", func, { id: 42, prop: [2, 3] }]);
    ...
    tests("match", function (pass, fail, shouldThrow, add) {
        ...
        if (typeof Set !== 'undefined') {
            ...
            pass("differently sorted complex objects", new Set([{
