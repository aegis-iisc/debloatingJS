...
var operations = {
  ...
  */
	...
	$exists: function $exists(qu, value) {
  ...
  * probe.find( data, {attr : {$elemMatch : [
     ...
     * ]}} );
  */
	$elemMatch: function $elemMatch(qu, value) {
  ...
  */
	...
	$and: function $and(qu, value, record) {
		var isAnd = false;
  ...
  * ]} );
  */
	$or: function $or(qu, value, record) {
		var isOr = false;
		sys.each(qu.operands, function (expr) {
			if (expr.path) {
				expr.splitPath = expr.splitPath || splitPath(expr.path);
  ...
  * probe.find( data, {$nor : [
     ...
     * ]} );
  */
	$nor: function $nor(qu, value, record) {
		var isOr = false;
		sys.each(qu.operands, function (expr) {
			if (expr.path) {
				expr.splitPath = expr.splitPath || splitPath(expr.path);
  ...
  */
	$not: function $not(qu, value, record) {
