...
var CollectorBase = dcl(Destroyable, {
  ...
  */
	each: function each(query, iterator, thisobj) {
  ...
  * @param {object=} thisobj The value of `this`
  */
	map: function map(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {*}
  */
	reduce: function reduce(query, iterator, accumulator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {object}
  */
	countBy: function countBy(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {object}
  */
	groupBy: function groupBy(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {*}
  */
	pluck: function pluck(query, property) {
  ...
  * @return {array}
  */
	sortBy: function sortBy(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {number}
  */
	max: function max(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
  ...
  * @return {number}
  */
	min: function min(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
...
var ACollector = dcl(CollectorBase, {
  ...
  * @return {number}
  */
	flatten: function flatten(query, iterator, thisobj) {
		if (sys.isPlainObject(query)) {
			thisobj = thisobj || this;
