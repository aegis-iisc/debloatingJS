...
var Signal = Base.compose([Base, signals.Signal], /** @lends module:mixins/signalable~Signal# */{
	...
	constructor: function constructor(host, name, options) {
		options = options || {};
  ...
  */
	on: function on(listener, listenerContext, priority) {
  ...
  * @returns {function}
  */
	off: function off(listener, listenerContext) {
  ...
  * @returns {boolean}
  */
	has: function has(listener, listenerContext) {
		listenerContext = listenerContext || this.defaultContext || this.host;
		return this.remove(listener, listenerContext);
	},
	/**
...
var Signalable = Base.compose([Base], /** @lends mixins/signalable# */{
  ...
  */
	refreshSignals: function refreshSignals() {
		this._loadSignals();
	},
  ...
  * @private
  */
	_loadSignals: function _loadSignals() {
  ...
  * @private
  */
	_addSignal: function _addSignal(name, options) {
  ...
  * @private
  */
	_addSignals: function _addSignals(signals) {
		signals = signals || {};
		if (this.options) {
