...
var Bussable = Base.compose([Base], /** @lends mixins/bussable# */{
  ...
  */
	subscribe: function subscribe(channel, topic, callback) {
  ...
  * @returns {object} The subscription definition
  */
	once: function once(channel, topic, callback) {
  ...
  */
	publish: function publish(channel, topic, options) {
  ...
  * @returns {object=} The subscription definition
  */
	getSubscription: function getSubscription(channel, topic) {
