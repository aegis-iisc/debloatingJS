...
extend(FakeXMLHttpRequest.prototype, sinonEvent.EventTarget, {
    ...
    send: function send(data) {
        ...
        if (sinonXhr.supportsTimeout && _typeof(setInterval.clock) === "object" && _typeof(Date.clock) === "object") {
            ...
            var clearIntervalId = setInterval(function () {
                ...
                if (self.readyState === FakeXMLHttpRequest.UNSENT || self.readyState === FakeXMLHttpRequest.DONE) {
