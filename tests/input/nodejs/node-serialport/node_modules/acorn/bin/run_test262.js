...
var unsupportedFeatures = ["BigInt", "class-fields", "class-fields-private", "class-fields-public", "numeric-separator-literal", "optional-catch-binding"];

run(function (content, _ref) {
  var sourceType = _ref.sourceType;
  return parse(content, { sourceType: sourceType, ecmaVersion: 9 });
}, {
