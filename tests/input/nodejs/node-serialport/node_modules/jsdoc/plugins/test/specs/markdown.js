...
describe('markdown plugin', function () {
    ...
    it('should process the correct tags by default', function () {
        ...
        [myClass.author[0], myClass.classdesc, myClass.description, myClass.exceptions[0].description, myClass.params[0].description, myClass.properties[0].description, myClass.returns[0].description, myClass.see, myClass.summary].forEach(function (value) {
    ...
    describe('@see tag support', function () {
        ...
        it('should parse @see tags containing links', function () {
            ...
            expect(typeof foo === 'undefined' ? 'undefined' : _typeof(foo)).toEqual('object');
        ...
        it('should not parse @see tags that do not contain links', function () {
            ...
            expect(typeof bar === 'undefined' ? 'undefined' : _typeof(bar)).toEqual('object');
