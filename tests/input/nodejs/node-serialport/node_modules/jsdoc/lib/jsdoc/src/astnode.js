...
var isFunction = exports.isFunction = function (node) {
    ...
    return type === Syntax.FunctionDeclaration || type === Syntax.FunctionExpression || type === Syntax.MethodDefinition || type === Syntax.ArrowFunctionExpression;
};
...
exports.isScope = function (node) {
    ...
    return Boolean(node) && (typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && (node.type === Syntax.CatchClause || node.type === Syntax.ClassDeclaration || node.type === Syntax.ClassExpression || isFunction(node));
};
...
var nodeToValue = exports.nodeToValue = function (node) {
    ...
    switch (node.type) {
        ...
        case Syntax.MethodDefinition:
            ...
            else if (node.kind === 'constructor' && parent.parent && parent.parent.type === Syntax.ExportDefaultDeclaration) {
                    str = 'module.exports';
                }
                // for the constructor of a module's named export, use the name of the export
                // declaration
                else if (node.kind === 'constructor' && parent.parent && parent.parent.type === Syntax.ExportNamedDeclaration) {
                        str = nodeToValue(parent.parent);
                    }
...
var isAccessor = exports.isAccessor = function (node) {
    return Boolean(node) && (typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && (node.type === Syntax.Property || node.type === Syntax.MethodDefinition) && (node.kind === 'get' || node.kind === 'set');
};

// TODO: docs
exports.isAssignment = function (node) {
    return Boolean(node) && (typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && (node.type === Syntax.AssignmentExpression || node.type === Syntax.VariableDeclarator);
};
