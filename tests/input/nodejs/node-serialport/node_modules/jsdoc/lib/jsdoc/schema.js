...
var META_SCHEMA = exports.META_SCHEMA = {
    ...
    properties: {
        ...
        range: {
            title: 'The positions of the first and last characters of the code associated with ' + 'this doclet.',
            type: ARRAY,
            optional: true,
            minItems: 2,
            maxItems: 2,
...
var DOCLET_SCHEMA = exports.DOCLET_SCHEMA = {
    ...
    properties: {
        ...
        kind: {
            type: STRING,
            // TODO: define this as an enumeration elsewhere
            enum: ['class', 'constant', 'event', 'external', 'file', 'function', 'interface', 'member', 'mixin', 'module', 'namespace', 'package', 'param', 'typedef']
        },
        license: {
            type: STRING,
            optional: true
