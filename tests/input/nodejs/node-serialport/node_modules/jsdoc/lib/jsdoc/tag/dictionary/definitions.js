...
var baseTags = exports.baseTags = {
    abstract: {
        ...
        onTagged: function onTagged(doclet) {
    ...
    type: {
        ...
        canHaveType: true,
        onTagText: function onTagText(text) {
            var closeIdx;
            var openIdx;
...
exports.defineTags = function (dictionary, tagDefinitions) {
    ...
    if (!tagDefinitions) {
        ...
        if (!dictionaries) {
            jsdoc.util.logger.error('The configuration setting "tags.dictionaries" is undefined. ' + 'Unable to load tag definitions.');
        ...
        dictionaries.forEach(function (dictName) {
            ...
            if (!tagDefs) {
                jsdoc.util.logger.error('The configuration setting "tags.dictionaries" contains ' + 'the unknown dictionary name %s. Ignoring the dictionary.', dictName);
