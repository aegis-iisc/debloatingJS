...
function setModuleScopeMemberOf(parser, doclet) {
    ...
    if (currentModule && currentModule.longname !== doclet.name) {
        if (!doclet.scope) {
            ...
            else if (doclet.meta && doclet.meta.code && doclet.meta.code.node && doclet.meta.code.node.parent && doclet.meta.code.node.parent.type === Syntax.ExportNamedDeclaration) {
                    doclet.addTag('static');
                }
