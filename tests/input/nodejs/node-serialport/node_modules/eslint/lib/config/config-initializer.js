...
function installModules(config, installESLint) {
    ...
    if (config.extends && config.extends.indexOf("eslint:") === -1) {
        var moduleName = "eslint-config-" + config.extends;
    ...
    if (installESLint === false) {
        ...
        var installStatus = npmUtil.checkDevDeps(["eslint"]);
    ...
    // Install packages
    var modulesToInstall = Object.keys(modules).map(function (name) {
...
function getLocalESLintVersion() {
    try {
        ...
        var eslintPath = resolver.resolve("eslint", process.cwd());
...
function hasESLintVersionConflict(answers) {
    ...
    var moduleName = "eslint-config-" + configName + "@latest";
...
function promptUser() {
    ...
    return inquirer.prompt([{
        ...
        if (earlyAnswers.source === "guide") {
            ...
            var config = getConfigForStyleGuide(earlyAnswers.styleguide, earlyAnswers.installESLint);
        ...
        return inquirer.prompt([{
            ...
            if (earlyAnswers.source === "auto") {
                ...
                var _config = processAnswers(combinedAnswers);

                installModules(_config);
                writeFile(_config, earlyAnswers.format);
...
var init = {
    ...
    /* istanbul ignore next */initializeConfig: function initializeConfig() {
        return promptUser();
    }
};
