...
var Plugins = function () {
     ...
     */
    function Plugins(envContext, rulesContext) {
    ...
    _createClass(Plugins, [{
        key: "define",
        value: function define(pluginName, plugin) {
            var pluginNamespace = naming.getNamespaceFromTerm(pluginName),
        ...
        value: function load(pluginName) {
            ...
            if (!this._plugins[shortName]) {
                ...
                if (debug.enabled) {
                    var resolvedPath = require.resolve(longName);
                    ...
                    var loadedPluginAndVersion = version ? longName + "@" + version : longName + ", version unknown";
        ...
        key: "loadAll",
        value: function loadAll(pluginNames) {

            // if "plugins" in config is not an array, throw an error so user can fix their config.
            if (!Array.isArray(pluginNames)) {
                var pluginNotArrayMessage = "ESLint configuration error: \"plugins\" value must be an array";
