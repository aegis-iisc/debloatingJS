...
function installSyncSaveDev(packages) {
    ...
    var npmProcess = spawn.sync("npm", ["i", "--save-dev"].concat(packageList), { stdio: "inherit" });
...
function fetchPeerDependencies(packageName) {
    var npmProcess = spawn.sync("npm", ["show", "--json", packageName, "peerDependencies"], { encoding: "utf8" });
