...
function listFilesToProcess(globPatterns, providedOptions) {
    var options = providedOptions || { ignore: true };
    var files = [];
    var added = {};

    var cwd = options.cwd || process.cwd();

    var getIgnorePaths = lodash.memoize(function (optionsObj) {
        return new IgnoredPaths(optionsObj);
    });
    ...
    globPatterns.forEach(function (pattern) {
        ...
        if (fs.existsSync(file) && fs.statSync(file).isFile()) {
            ...
            var _ignoredPaths = getIgnorePaths(newOptions);
