...
var RuleTester = function () {
    ...
    _createClass(RuleTester, [{
        ...
        value: function run(ruleName, rule, test) {
            ...
            if (lodash.isNil(test) || (typeof test === "undefined" ? "undefined" : _typeof(test)) !== "object") {
            ...
            function runRuleForItem(item) {
                ...
                var schema = validator.getRuleOptionsSchema(rule);
                ...
                if (typeof item.errors === "number") {
                    ...
                    for (var i = 0, l = item.errors.length; i < l; i++) {
                        ...
                        if (typeof error === "string" || error instanceof RegExp) {
                            ...
                            if (error.messageId) {
                                var hOP = Object.hasOwnProperty.call.bind(Object.hasOwnProperty);
                                ...
                                if (!hOP(rule.meta.messages, error.messageId)) {
                                    var friendlyIDList = "[" + Object.keys(rule.meta.messages).map(function (key) {
                                        return "'" + key + "'";
                                    }).join(", ") + "]";
                                ...
                                var expectedMessage = rule.meta.messages[error.messageId];
                ...
                if (item.hasOwnProperty("output")) {
                    if (item.output === null) {
                        assert.strictEqual(messages.filter(function (message) {
                            return message.fix;
                        }).length, 0, "Expected no autofixes to be suggested");
                    } else {
                        var fixResult = SourceCodeFixer.applyFixes(item.code, messages);
            ...
            RuleTester.describe(ruleName, function () {
                RuleTester.describe("valid", function () {
                    test.valid.forEach(function (valid) {
                        RuleTester.it((typeof valid === "undefined" ? "undefined" : _typeof(valid)) === "object" ? valid.code : valid, function () {
