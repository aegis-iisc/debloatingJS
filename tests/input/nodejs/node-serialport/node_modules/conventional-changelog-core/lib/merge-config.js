...
try {
  ...
  gitRemoteOriginUrl = function gitRemoteOriginUrl() {
    return Q.reject(err);
  };
}
...
function mergeConfig(options, context, gitRawCommitsOpts, parserOpts, writerOpts) {
  ...
  options = _.merge({
    ...
    transform: function transform(commit, cb) {
  ...
  return Q.allSettled([configPromise, pkgPromise, semverTagsPromise(options), gitRemoteOriginUrlPromise]).spread(function (configObj, pkgObj, tagsObj, gitRemoteOriginUrlObj) {
    ...
    writerOpts = _.assign({
      finalizeContext: function finalizeContext(context, writerOpts, filteredCommits, keyCommit, originalCommits) {
