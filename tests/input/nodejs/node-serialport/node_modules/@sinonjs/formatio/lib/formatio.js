...
(function (root, factory) {
...
})(typeof self !== "undefined" ? self : undefined, function (samsam) {
    "use strict";
    ...
    function _ascii(f, object, processed, indent) {
        ...
        if (typeof Set !== "undefined" && object instanceof Set) {
            return _ascii.set.call(f, object, processed);
        }
    ...
    _ascii.array = function (array, processed, delimiters) {
        processed = processed || [];
    ...
    _ascii.set = function (set, processed) {
        return _ascii.array.call(this, Array.from(set), processed, ["Set {", "}"]);
    };
