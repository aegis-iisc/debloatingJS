  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
      ...
      return result;
        ...
        peg$c5 = function peg$c5(r, prefix, expr) {
      var result = expr;
      ...
      return nullable(result, prefix);
        ...
        peg$c6 = function peg$c6(expr, optionalPre, postfix, optionalPost) {
      var result = expr;
      ...
      return result;
        ...
        peg$c7 = function peg$c7(expr, postfix) {
      return nullable(expr, postfix);
    },
        peg$c8 = function peg$c8(prefix, expr) {
      prefix = prefix || '';

      return nullable(expr, prefix);
    },
        peg$c9 = function peg$c9(expr, postfix) {
      postfix = postfix || '';
      ...
      return repeatable(expr);
        ...
        peg$c11 = function peg$c11(lit, opt) {
      var result = lit;
      ...
      return {
        ...
        peg$c26 = function peg$c26(name, brackets) {
      var result;
      ...
      return result;
        ...
        peg$c27 = function peg$c27(exp, appl, opt) {
      var result = {};
      ...
      return result;
        ...
        peg$c28 = function peg$c28(t) {
      return repeatable(t);
    },
        peg$c29 = function peg$c29(exp, opt) {
      var result = {
        type: Types.NameExpression,
        name: exp.name,
        reservedWord: true
      ...
      return result;
        ...
        peg$c36 = function peg$c36(sep, l) {
      return l;
    },
        peg$c37 = ",",
        peg$c38 = { type: "literal", value: ",", description: "\",\"" },
        peg$c39 = function peg$c39(expr, list) {
      var result = [expr];
      ...
      return result;
        ...
        peg$c41 = function peg$c41(sig, opt) {
      ...
      return result;
        ...
        peg$c48 = function peg$c48(sig, returns) {
      var result = {};
      ...
      return result;
        ...
        peg$c49 = function peg$c49(funcNew, funcThis, params) {
      var result = {
      ...
      return result;
        ...
        peg$c50 = function peg$c50(funcThis, funcNew, params) {
      var result = {
        params: params ? params[3] : [],
        'this': funcThis
      };
      ...
      return result;
        ...
        peg$c51 = function peg$c51(params) {
      return {
        params: params
      };
    },
        ...
        peg$c54 = function peg$c54(expr) {
      return expr;
    },
        peg$c55 = "this",
        peg$c56 = { type: "literal", value: "this", description: "\"this\"" },
        peg$c57 = function peg$c57(rp) {
      return [rp];
    },
        peg$c58 = function peg$c58(nrp, rp) {
      var result = [];
      if (nrp !== '') {
        result = nrp;
      }
      ...
      return result;
        ...
        peg$c59 = function peg$c59(p, list) {
      var result = [p];
      for (var i = 0, l = list.length; i < l; i++) {
        result.push(list[i][3]);
      }
      return result;
        ...
        peg$c60 = function peg$c60(op, list) {
      var result = [op];
      for (var i = 0, l = list.length; i < l; i++) {
        result.push(list[i][3]);
      }
      return result;
        ...
        peg$c61 = function peg$c61(paramType) {
      return paramType;
    },
      ...
      return t;
        ...
        peg$c67 = function peg$c67(t) {
      return repeatable(t || '');
    },
        peg$c68 = function peg$c68() {
      return repeatable({});
    },
        peg$c69 = function peg$c69(t, opt) {
      var result = {
      ...
      return result;
        ...
        peg$c70 = function peg$c70(tu) {
      return repeatable(tu);
    },
        peg$c71 = function peg$c71(expr, list) {
      var result = [expr];
      for (var i = 0, l = list.length; i < l; i++) {
      ...
      return result;
        ...
        peg$c72 = function peg$c72(expr, list) {
      var result = [expr];
      ...
      return '';
        ...
        peg$c81 = function peg$c81(list, opt) {
      var result = {
      ...
      return result;
        ...
        peg$c82 = function peg$c82(type, list) {
      var result = [type];
      ...
      return result;
        ...
        peg$c83 = function peg$c83(key, expr) {
      var result = {
      ...
      return {
        ...
        peg$c87 = function peg$c87(id, props) {
      props = props || '';
      ...
      return {
        ...
        peg$c88 = function peg$c88(rw) {
      return {
        name: rw
      };
    },
        peg$c89 = function peg$c89(lit) {
      return '"' + lit + '"';
    },
        peg$c90 = function peg$c90(lit) {
      return "'" + lit + "'";
    },
        peg$c91 = "#",
        ...
        peg$c97 = function peg$c97(sep, prop) {
      ...
      return name;
        ...
        peg$c111 = function peg$c111(parts) {
      if (!options.jsdoc) {
        return null;
      }
      ...
      return '(' + parts.join(', ') + ')';
        ...
        peg$c112 = function peg$c112(params) {
      if (!options.jsdoc) {
        return null;
      }
      ...
      return kw;
        ...
        peg$c192 = function peg$c192(frw) {
      return frw;
    },
        peg$c193 = "\"",
        peg$c194 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c195 = function peg$c195(str) {
      return str;
    },
        peg$c196 = "'",
        peg$c197 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c198 = function peg$c198(lit, digits, exp) {
      return parseFloat(lit + '.' + (digits || '') + (exp || ''));
    },
        peg$c199 = function peg$c199(digits, exp) {
      return parseFloat('.' + digits + (exp || ''));
    },
        peg$c200 = function peg$c200(lit, exp) {
      return parseFloat(lit + (exp || ''));
        ...
        peg$c209 = function peg$c209(hex) {
      ...
      return {
        ...
        peg$c227 = function peg$c227(hex) {
      return String.fromCharCode(parseInt('0x' + hex), 16);
        ...
        peg$c264 = function peg$c264(c) {
      return c;
    },
        peg$c265 = function peg$c265(seq) {
      return seq;
    },
        peg$c266 = "\n",
    ...
    {
      var _optional = function _optional(obj) {
        obj.optional = true;
        return obj;
      };

      var _repeatable = function _repeatable(obj) {
        obj.repeatable = true;
        return obj;
      };

      var _nullable = function _nullable(obj, modifier) {
        if (modifier) {
