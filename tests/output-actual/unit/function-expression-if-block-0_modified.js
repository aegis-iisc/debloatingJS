...
if (condition) {
    ...
    g = function () {
                if (original__8_5 == null) {
            lazyLoad('_8_5', srcFile);
            var loadedBody = loadAndInvoke('_8_5', srcFile);
            eval('original__8_5 = ' + loadedBody);
            _8_5 = original__8_5;
        }
                original__8_5.apply(this);
    };
} else {
    f = function () {
